...
vertex15.distribution = {70: 0.1, 0: 0.9}
...
vertex11.neighbours = [vertex12, vertex6]
vertex12.neighbours = [vertex13, vertex11, vertex7]
vertex13.neighbours = [vertex14, vertex12, vertex8]
vertex14.neighbours = [vertex15, vertex13, vertex9]
...
agents = [agent0]
instance1 = Instance.Instance("grid5AG", map1, agents, 6)
