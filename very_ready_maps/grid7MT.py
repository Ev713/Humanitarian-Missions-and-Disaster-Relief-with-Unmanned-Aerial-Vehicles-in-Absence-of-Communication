...
vertex41.neighbours = [vertex42, vertex33]
vertex42.neighbours = [vertex43, vertex41, vertex34]
vertex43.neighbours = [vertex44, vertex42, vertex35]
vertex44.neighbours = [vertex45, vertex43, vertex36]
vertex45.neighbours = [vertex46, vertex44, vertex37]
vertex46.neighbours = [vertex47, vertex45, vertex38]
vertex47.neighbours = [vertex48, vertex46, vertex39]
vertex48.neighbours = [vertex47, vertex40]
agent0 = Agent.Agent(0, vertex1, 5, 5)
agent1 = Agent.Agent(1, vertex1, 9, 8)
map1 = [
...
instance1 = Instance.Instance("grid7MT", map1, agents, 9)
