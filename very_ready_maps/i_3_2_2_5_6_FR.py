...
vertex1.distribution = {1: 0.202, 0: 0.798}
vertex2 = Vertex.Vertex(2)
vertex2.distribution = {1: 0.1279, 0: 0.8721}
vertex3 = Vertex.Vertex(3)
vertex3.distribution = {1: 0.7875, 0: 0.2125}
vertex4 = Vertex.Vertex(4)
vertex4.distribution = {1: 0.1674, 0: 0.8326}
...
agent3 = Agent.Agent(3, vertex1, 6, 5)
agent4 = Agent.Agent(4, vertex1, 3, 6)
map1 = [
        vertex1, vertex2, 
        vertex3, vertex4, ]
agents = [agent0, agent1, agent2, agent3, agent4]
instance1 = Instance.Instance("i_3_2_2_5_6_FR", map1, agents, 6)
