...
agent0 = Agent.Agent(0, vertex1, 18, 1)
agent1 = Agent.Agent(1, vertex1, 17, 2)
agent2 = Agent.Agent(2, vertex1, 19, 12)
...
instance1 = Instance.Instance("grid9AG", map1, agents, 19)
