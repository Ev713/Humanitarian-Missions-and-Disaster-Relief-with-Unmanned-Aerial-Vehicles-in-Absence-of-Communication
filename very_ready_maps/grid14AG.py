...
vertex100.distribution = {70: 0.1, 0: 0.9}
...
agent0 = Agent.Agent(0, vertex1, 18, 17)
agent1 = Agent.Agent(1, vertex1, 18, 18)
agent2 = Agent.Agent(2, vertex1, 18, 9)
agent3 = Agent.Agent(3, vertex1, 18, 9)
map1 = [
...
instance1 = Instance.Instance("grid14AG", map1, agents, 18)
