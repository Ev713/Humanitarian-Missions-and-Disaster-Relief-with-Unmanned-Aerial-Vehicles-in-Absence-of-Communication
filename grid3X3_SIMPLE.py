...
vertex3.distribution = {0: 0.5, 1: 0.25, 2: 0.25}
vertex4 = Vertex.Vertex(4)
vertex4.distribution = {0: 0.5, 1: 0.25, 2: 0.25}
vertex5 = Vertex.Vertex(5)
vertex5.distribution = {0: 0.5, 1: 0.25, 2: 0.25}
vertex6 = Vertex.Vertex(6)
vertex6.distribution = {0: 0.5, 1: 0.25, 2: 0.25}
vertex7 = Vertex.Vertex(7)
vertex7.distribution = {0: 0.5, 1: 0.25, 2: 0.25}
vertex8 = Vertex.Vertex(8)
vertex8.distribution = {0: 0.5, 1: 0.25, 2: 0.25}
