...
vertex1.distribution = {1: 0.6392, 0: 0.3608}
vertex2 = Vertex.Vertex(2)
vertex2.distribution = {1: 0.3161, 0: 0.6839}
vertex3 = Vertex.Vertex(3)
vertex3.distribution = {1: 0.6432, 0: 0.3568}
vertex4 = Vertex.Vertex(4)
vertex4.distribution = {1: 0.154, 0: 0.846}
...
instance1 = Instance.Instance("i_3_2_2_3_3_FR", map1, agents, 3)
