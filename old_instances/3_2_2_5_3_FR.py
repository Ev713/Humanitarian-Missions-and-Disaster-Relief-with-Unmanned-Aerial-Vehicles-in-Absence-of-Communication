...
vertex1.distribution = {1: 0.6176, 0: 0.3824}
vertex2 = Vertex.Vertex(2)
vertex2.distribution = {1: 0.2238, 0: 0.7762}
vertex3 = Vertex.Vertex(3)
vertex3.distribution = {1: 0.3111, 0: 0.6889}
vertex4 = Vertex.Vertex(4)
vertex4.distribution = {1: 0.5124, 0: 0.4876}
...
instance1 = Instance.Instance("3_2_2_5_3_FR", map1, agents, 3)
